      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg mx-auto text-gray-700">
            <p>
              <strong>Axion Manufacturing LLC</strong> was born from a simple yet powerful idea: 
              American businesses deserve a <em>US manufacturing partner</em> that eliminates all the headaches of 
              dealing with international suppliers while delivering exceptional quality at competitive prices.
            </p>
            
            <p>
              Our founders, with over 30 years of combined experience in the manufacturing industry, recognized 
              the challenges faced by procurement departments: overseas suppliers meant complex wire transfers, 
              customs delays, legal uncertainty, and month-long vendor approval processes. Domestic alternatives 
              were often too expensive or lacked flexibility.
            </p>
            
            <p>
              <strong>As a US LLC, we present the perfect solution.</strong> You buy from, contract with, and 
              legally deal with a US entity — giving you full legal protection, easy ACH/check payments, Net 30 
              terms, and 1-day vendor approval. We handle ALL logistics and importation through our optimized 
              supply chain, so parts arrive at your dock as domestic shipments. No customs headaches. No international 
              wire transfers. Just hassle-free American business.
            </p>
            
            <p>
              Today, Axion Manufacturing LLC operates with state-of-the-art manufacturing capabilities including 
              CNC machining and 3D printing. Our team of skilled engineers 
              and technicians work closely with clients to deliver precision parts that meet the highest standards. 
              You get all of this with the ease and security of buying from a domestic US company.
            </p>
